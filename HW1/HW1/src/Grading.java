...
public class Grading
{
 	...
 	{
File file = new File("D:\\New Folder\\Documents\\JAVA Lab 6060\\HW1\\HW1-data.txt");
	 String st,pre=null;	    
File file1 =new File("D:\\New Folder\\Documents\\JAVA Lab 6060\\HW1\\Output.txt");
	  FileWriter fr = null;
...
StringTokenizer token = new StringTokenizer(st);	//allows string to break into //tokens in a line
  ...
  {
		try {
		 if(indata[0]/10000000<1) 
		 		{	//to check if roll no if starting with 0
